            ...
            <article class="bg-white rounded-2xl card-shadow overflow-hidden">
              <div class="relative">
                <?php if (!empty($row['filename']) && file_exists(__DIR__ . '/uploads/' . $row['filename'])): ?>
                  <img src="uploads/<?php echo $row['filename']; ?>" class="w-full object-cover h-44" alt="car image" loading="lazy" />
                <?php else: ?>
                ...
                <div class="p-4">
                  ...
                  <p class="text-sm text-gray-500 mt-2">Uploaded by: <span class="font-medium"><?php echo $row['uploader']; ?></span></p>
